...
/**
 * <p>JMS:  This is a modified version of the New Atlanta Deferred servlet, which can be
 * found in its original form 
 * <a href="http://code.google.com/p/gaevfs/source/browse/trunk/src/com/newatlanta/appengine/taskqueue/Deferred.java">here</a>.
 * Changes include using Runnable as the base task interface, and providing a preRun() hook.
 * </p>
 * 
 * 
...
public class Deferred extends HttpServlet {
     ...
     */
    public interface Deferrable extends Runnable, Serializable { }
    ...
    /**
     * You can override this method to perform some special action on a task that
     * has been deserialized but before it is run.  This can be used, for example,
     * to run guice injection with injector.injectMembers().
     * 
     * Default implementation does nothing.
     */
    protected void preRun( Object task )
    {
    }
}
